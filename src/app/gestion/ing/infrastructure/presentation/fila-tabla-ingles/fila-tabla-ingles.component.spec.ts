...
import { FilaTablaComponent } from '../../../../esp/infrastructure/presentation/fila-tabla/fila-tabla.component';
import { NavMenuComponent } from 'src/app/shared/infrastructure/presentation/nav-menu/nav-menu.component';
...
import { FilaTablaInglesComponent } from './fila-tabla-ingles.component';


describe('FilaTablaInglesComponent', () => {
  let component: FilaTablaInglesComponent;
  let fixture: ComponentFixture<FilaTablaInglesComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [FilaTablaInglesComponent,
        FilaTablaComponent,
        AppComponent,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(FilaTablaInglesComponent);
